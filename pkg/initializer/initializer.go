...
import (
	...
	"github.com/kubernetes-sigs/kube-storage-version-migrator/pkg/clientset/typed/migration/v1alpha1"
	"k8s.io/api/core/v1"
...
func (init *initializer) initializeCRD() error {
	...
	// TODO: do I need to wait for the CR to be removed from the discovery
	// API, like what's done in fixture.DeleteCustomResourceDefinition()?
